...
const Banner = () => {
  return (
    <div className='bg-image py-12 text-center space-y-3 items-center flex rounded-xl flex-col'>
      ...
      <p className='text-gray-600'>Beyond Boundaries Beyond Limits</p>
       <button className='btn bg-[#E7FE29] border-black outline-[#E7FE29]'>Claim Free Credit</button>    
    </div>
  );
};
